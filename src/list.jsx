          ...
          <tr key={index}>
            <td>
              <Link
                ...
                onClick={() => this.prepareProfile(row)}
              >
                {row.name}
              </Link>
            </td>
              ...
              <thead>
                <tr>
                  ...
                  <th
                    ...
                    onClick={this.sort.bind(this, "specie")}
                  >
                    Specie
                  </th>
                </tr>
